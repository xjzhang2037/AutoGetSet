...
/* Basic Methods Generator Program  */
/* @author Xin Zhang               */
...
int main(int argc , char* argv[]){
	...
	/* The argv[1] should be flags and argv[3] should have a var type If so, set properly */
...
void defaultMsg(){
		printf("Automatically prints function prototypes / getters / setters / modifiers for arguments to the terminal.\nUsage: mkgset -[flags] -[type] [arg1] [arg2] ... [argn]\nWhere type is the object to return or set as char[80].\n\nFlags:\n\tm : Makes a modifier for the argument. arg += mod\n\tg : Makes a getter for the argument\n\ts : Makes a setter for the argument.\n\tp : Generates a function prototype for others. Will be written first.\n");
		exit(1);
}
